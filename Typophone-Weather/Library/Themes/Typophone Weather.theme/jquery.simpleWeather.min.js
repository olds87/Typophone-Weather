...
(function($) {
	$.extend({
		simpleWeather: function(options){
			...
			//Icon Root
			var iconRoot = "weather/";
			$.get("weather.txt", function(d){
				weather = eval("("+d+")");
				if(weather.theme !=null && weather.theme.length>1)
					{
					iconRoot == weather.theme + "/";
					}
			});
					...
					if(data != null && data.query.results != null) {
						$.each(data.query.results, function(i, result) {
							...
							var weather = {					
								...
								image: [iconRoot+result.item.condition.code+timeOfDay+".png",
								iconRoot+result.item.forecast[0].code+timeOfDay+".png"],//"http://l.yimg.com/a/i/us/nws/weather/gr/"+result.item.condition.code+timeOfDay+".png",
								tomorrow:{
									...
									image: iconRoot+result.item.forecast[1].code+"d.png"
								},
