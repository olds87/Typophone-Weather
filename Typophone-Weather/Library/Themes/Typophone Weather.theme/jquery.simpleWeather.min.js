					...
					if(data != null && data.query.results != null) {
						$.each(data.query.results, function(i, result) {
							...
							var weather = {					
								...
								image: ["weather/"+result.item.condition.code+timeOfDay+".png",
								"weather/"+result.item.forecast[0].code+timeOfDay+".png"],//"http://l.yimg.com/a/i/us/nws/weather/gr/"+result.item.condition.code+timeOfDay+".png",
								tomorrow:{
									...
									image: "weather/"+result.item.forecast[1].code+"d.png"
								},
